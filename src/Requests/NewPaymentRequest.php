...
class NewPaymentRequest extends Request
{
	...
	{
		return md5($this->posId . $this->payType . $this->sessionId . $this->posAuthKey . $this->amount . $this->desc . $this->desc2 . $this->orderId . $this->firstName . $this->lastName . $this->street . $this->streetHn . $this->streetAn . $this->city . $this->postCode . $this->country . $this->email . $this->phone . $this->language . $this->clientIp . $this->ts . $key);
	}
